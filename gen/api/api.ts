...
export const PetApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        deletePet(petId: number, api_key?: string, options: any = {}): RequestArgs {
...
export const PetApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        deletePet(petId: number, api_key?: string, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void> {
            const localVarAxiosArgs = PetApiAxiosParamCreator(configuration).deletePet(petId, api_key, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const PetApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        deletePet(petId: number, api_key?: string, options?: any) {
            return PetApiFp(configuration).deletePet(petId, api_key, options)(axios, basePath);
        },
        /**
         * Multiple status values can be provided with comma separated strings
         * @summary Finds Pets by status
...
export class PetApi extends BaseAPI {
    ...
    public deletePet(petId: number, api_key?: string, options?: any) {
        return PetApiFp(this.configuration).deletePet(petId, api_key, options)(this.axios, this.basePath);
    }
...
export const StoreApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        deleteOrder(orderId: number, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void> {
